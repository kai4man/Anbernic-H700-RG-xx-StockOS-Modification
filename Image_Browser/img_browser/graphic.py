...
def display_image(image_path, target_x=0, target_y=0, 
    ...
    if target_width is None:
        target_width = int(screen_width * zoom)
    if target_height is None:
        target_height = int(screen_height * zoom)
...
def preview_image(image_path, target_x=0, target_y=0, target_width=None, target_height=None):
    global activeImage
    if target_width is None:
